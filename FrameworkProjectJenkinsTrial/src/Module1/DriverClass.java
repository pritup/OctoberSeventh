...
public static void testt() throws Throwable
{
	...
	Thread.sleep(2000);
	Reporter.log("<td><h4>(1)Execution Result for 'Can't Access Account' Class-</td><td><a href="+Path2+">Detailed Result</a></td></h4>");

	LoginModule.LoginTestCase(); 
	Thread.sleep(2000);
	Reporter.log("<td><h4>(1)Execution Result for 'Login' Class-</td><td><a href="+Path3+">Detailed Result</a></td></h4>");
